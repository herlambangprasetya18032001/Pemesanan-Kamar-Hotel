            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Data Pemesanan Kamar</h6>
                </div>
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush" id="dataTable">
					...
					<?php 
					 require_once "..\config.php";
					 $query = mysqli_query($con,"SELECT tbl_booking.`id`,tbl_booking.`status`,tbl_pelanggan.`nama`,tbl_booking.`checkin`,tbl_booking.`checkout`
           FROM tbl_booking JOIN tbl_pelanggan ON tbl_booking.`id_pelanggan`= tbl_pelanggan.`id`");
					 $no =1;
            ...
            <td><a href="pembayaran.php?id=<?php echo $data['id']; ?>" name="proses" type="button" 
            class="btn btn-info mb-1">Proses</a> 
            <a href="checkout.php?id=<?php echo $data['id'];?>" name="proses" type="button" 
            class="btn btn-danger mb-1">checkout</a>          
          </td>
					</tr>
					<?php               
				  }
